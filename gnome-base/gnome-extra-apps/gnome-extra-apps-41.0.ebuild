...
IUSE="anjuta +bijiben boxes builder california +celluloid +dino empathy epiphany +evolution flashback +foliate +fonts +games gconf geary +ghex gnote gpaste latexila multiwriter +plots +polari +recipes +share +shotwell simple-scan software +text-editor +todo +tracker +usage"
...
RDEPEND="
	...
	evolution? ( >=mail-client/evolution-3.42.0 )
	flashback? ( >=gnome-base/gnome-flashback-3.42.0 )
	...
	simple-scan? ( >=media-gfx/simple-scan-40.0 )
