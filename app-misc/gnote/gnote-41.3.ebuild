...
PATCHES=(
	"${FILESDIR}"/${PN}-3.38.1-cstddef.patch

	# From GNOME:
	# 	https://gitlab.gnome.org/GNOME/gnote/-/commit/32795e53681e3ecbaaa05817d4eb5fa1c124d35b
	"${FILESDIR}"/${PN}-42.0-meson-drop-unused-argument-for-i18n-merge-file.patch
)
